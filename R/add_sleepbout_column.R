...
add_sleepbout_column = function(ts = c(), epochSize = c()) {
  ...
  bouts = detect_sleepbout(sleepBinary = sleepBinary, wakeBoutThreshold = 0.3, 
                              wakeBoutMin = 10, sleepBoutMin = 180, epochSize = epochSize)
  ts$sleepbouts = 0
  lastwindow = 0
